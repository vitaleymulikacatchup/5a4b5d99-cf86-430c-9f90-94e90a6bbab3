...
export const metadata: Metadata = {
  title: "Sweet Delights Bakery - Fresh Artisan Breads & Pastries Daily",
  description: "Family-owned bakery serving fresh artisan breads, pastries & custom cakes since 1985. Premium ingredients, traditional techniques. Order online or visit us today!",
  keywords: ["bakery", "fresh bread", "artisan pastries", "custom cakes", "wedding cakes", "croissants", "sourdough", "family bakery"],
  metadataBase: new URL("https://sweetdelightsbakery.com"),
  alternates: {
    canonical: "https://sweetdelightsbakery.com"
  },
  openGraph: {
    title: "Sweet Delights Bakery - Fresh Artisan Breads & Pastries",
    description: "Family-owned bakery serving fresh artisan breads, pastries & custom cakes since 1985. Premium ingredients, traditional techniques.",
    ...
    images: [{
      ...
      alt: "Fresh bakery display with artisan breads and pastries"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Sweet Delights Bakery - Fresh Artisan Breads & Pastries",
    description: "Family-owned bakery serving fresh artisan breads, pastries & custom cakes since 1985.",
    images: ["https://images.pexels.com/photos/4906454/pexels-photo-4906454.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
